/*CIRCULAR LINKED LIST USING CLASS */
...
class List : public node		//inheriting node class in List. List will contain all the methods
{
	public:
		...
		void display()			//this method displays all elements of a list
		{
			...
			{
				for(temp1 = listptr; temp1 != temp; temp1 = temp1->next)		//traversing through the list
				{
					cout << temp1->data << "\n";
				}
				cout << temp1->data << "\n";
		...
		void delete_by_search()		//this method deletes the element entered by the user
		{
			...
			{
				while((temp1->next)->data != search && temp1 != temp)
				{
					temp1=temp1->next;
				}
		...
		void search()				//to search for an element in a list
		{
			...
			{
				while(temp1->data != search && temp1 != temp)
				{
					temp1=temp1->next;
					i++;
				}
		...
		void sort()
		{
			...
			for(element2 = listptr; element2 != temp; element2 = element2->next)		//traversing through the list
			{
				count++;
			}
			count++;
			...
			{ 
			 	for(element1 = listptr;element1->next != listptr;element1 = element1->next)
			 	{
